...
class WorksheetWriter {
  ...
  _writePrintOptions() {
    this.stream.write(
      xform.printOptions.toXml({
        showRowColHeaders: this.pageSetup.showRowColHeaders,
        showGridLines: this.pageSetup.showGridLines,
        horizontalCentered: this.pageSetup.horizontalCentered,
        verticalCentered: this.pageSetup.verticalCentered,
      }),
    )
  }
