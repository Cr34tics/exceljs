...
const utils = {
  ...
  *range(start, stop, step = 1) {
  ...
  // Reports a streamed part's parse error to its 'error' listeners, if it has
  // any (emitting 'error' with none would throw), and always rethrows it: a
  // listener mustn't turn a corrupt part into a successful workbook read
  rethrowToListeners(emitter, error) {
