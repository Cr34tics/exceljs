...
class WorkSheetXform extends BaseXform {
  ...
  render(xmlStream, model) {
    ...
    this.map.colBreaks.render(xmlStream, model.colBreaks) // Note: must be after rowBreaks
  ...
  parseClose(name) {
    ...
    switch (name) {
      case 'worksheet': {
        ...
        if (this.map.rowBreaks.model) {
          this.model.rowBreaks = this.map.rowBreaks.model
        }
        if (this.map.colBreaks.model) {
          this.model.colBreaks = this.map.colBreaks.model
        }
